...
<?php if (isset($_POST['id'])) : ?>
    ...
    <?php if ($stmt->execute() === TRUE) : ?>
        <p>Registro deletado com sucesso! Clique <a class="linkVoltar" href="/sistema_corno/courses/classes/classlist.php">aqui</a> para voltar.</p>
    <?php else : ?>
        <p>Erro ao atualizar registro: <?= $stmt->error ?></p>
    <?php endif; ?>
<?php else : ?>
    <p>Algo de errado não está certo. Clique <a class="linkVoltar" href="/sistema_corno/courses/classes/classlist.php">aqui</a> para voltar.</p>
<?php endif; ?>
