            ...
            <form name='form1' action='/sistema_corno/locations/routines/editlocation.php' method='post'>
                <div class='formulario'>
                    ...
                    <?php if (havePermission('Locais', 'Nome', 'rw') || (havePermission('Locais', 'Nome', 'r'))) : ?>
                        <?php $readonly = setStringIfTrue('readonly', !havePermission('Locais', 'Nome', 'rw')) ?>
                        <div class='campos'>
                    ...
                    <?php if (havePermission('Locais', 'Endereco', 'rw') || (havePermission('Locais', 'Endereco', 'r'))) : ?>
                        <?php $readonly = setStringIfTrue('readonly', !havePermission('Locais', 'Endereco', 'rw')) ?>
                        <div class='campos'>
                    ...
                    <?php if (havePermission('Locais', 'Telefone', 'rw') || (havePermission('Locais', 'Telefone', 'r'))) : ?>
                        <?php $readonly = setStringIfTrue('readonly', !havePermission('Locais', 'Telefone', 'rw')) ?>
                        <div class='campos'>
                    ...
                    <?php endif; ?>
                    <?php if (havePermission('Locais', 'Responsavel', 'rw') || (havePermission('Locais', 'Responsavel', 'r'))) : ?>
                        <div class="campos">
                            <label class="labels" for="responsavel" data-placeholder="Escolha o chifrudo que vai gerenciar essa bagaça">Responsável</label>
                            <?php $disabled = setStringIfTrue('disabled', !havePermission('Locais', 'Responsavel', 'rw')) ?>
