...
?>
<?php if ($success) : ?>
  <p>Seus dados foram atualizados com sucesso! Clique <a class="linkVoltar" href="/sistema_corno/cuckolds/cuckoldupdate.php">aqui</a> para voltar.</p>
<?php else : ?>
  <p>Algo de errado não está certo: <?= $stmt->error ?></p>
<?php endif; ?>
